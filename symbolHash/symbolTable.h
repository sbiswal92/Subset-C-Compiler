...
struct symbolTable {
    ...
    struct symbolTableListEntry *parentSymbolTableEntry;
...
struct symbolTable* symbolTable_getChild(struct symbolTable* symbolTable, struct symbolTableListEntry *parentEntry);
